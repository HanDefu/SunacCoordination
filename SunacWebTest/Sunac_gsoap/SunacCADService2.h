...
/// Element "width" of type xs:double.
    double                               width                          1;	///< Required element.
/// Element "doorType" of type xs:int.
    int                                  doorType                       1;	///< Required element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
/// Element "Height" of type xs:double.
    double                               Height                         1;	///< Required element.
/// Element "KitchenDoorWindowPosition" of type xs:int.
    int                                  KitchenDoorWindowPosition      1;	///< Required element.
/// Element "KitchenType" of type xs:int.
    int                                  KitchenType                    1;	///< Required element.
/// Element "AirVent" of type xs:int.
    int                                  AirVent                        1;	///< Required element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
/// Element "Height" of type xs:double.
    double                               Height                         1;	///< Required element.
/// Element "BathroomDoorWindowPosition" of type xs:int.
    int                                  BathroomDoorWindowPosition     1;	///< Required element.
/// Element "ToiletType" of type xs:int.
    int                                  ToiletType                     1;	///< Required element.
/// Element "AirVent" of type xs:int.
    int                                  AirVent                        1;	///< Required element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
...
class _ns1__GetAllHandrailByParam
{ public:
/// Element "RailingType" of type xs:int.
    int                                  RailingType                    1;	///< Required element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
class _ns1__GetAllAirconditionerByParam
{ public:
/// Element "AirconditionerPower" of type xs:int.
    int                                  AirconditionerPower            1;	///< Required element.
/// Element "AirconditionerPipePosition" of type xs:int.
    int                                  AirconditionerPipePosition     1;	///< Required element.
/// Element "AirconditionerIsRainpipe" of type xs:int.
    int                                  AirconditionerIsRainpipe       1;	///< Required element.
/// Element "RainpipePosition" of type xs:int.
    int                                  RainpipePosition               1;	///< Required element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
