...
class _ns1__NewCadFileDir;

class _ns1__NewCadFileDirResponse;

class _ns1__DeleteCadFileDir;

class _ns1__DeleteCadFileDirResponse;

class _ns1__DeleteCadFileDirByDirId;

class _ns1__DeleteCadFileDirByDirIdResponse;

class _ns1__RenameCadFileDir;

class _ns1__RenameCadFileDirResponse;

class _ns1__GetProjectInfo;

class _ns1__GetProjectInfoResponse;

class _ns1__UpdateCadDrawing;

class _ns1__UpdateCadDrawingResponse;

class _ns1__DeleteCadDrawing;

class _ns1__DeleteCadDrawingResponse;

class _ns1__DeleteCadDrawingByFileID;

class _ns1__DeleteCadDrawingByFileIDResponse;

class _ns1__CheckUserInfo;

class _ns1__CheckUserInfoResponse;
...
/// @brief Top-level root element "http://tempuri.org/":NewCadFileDir
/// @brief "http://tempuri.org/":NewCadFileDir is a complexType.
///
/// @note class _ns1__NewCadFileDir operations:
/// - _ns1__NewCadFileDir* soap_new__ns1__NewCadFileDir(soap*) allocate and default initialize
/// - _ns1__NewCadFileDir* soap_new__ns1__NewCadFileDir(soap*, int num) allocate and default initialize an array
/// - _ns1__NewCadFileDir* soap_new_req__ns1__NewCadFileDir(soap*, ...) allocate, set required members
/// - _ns1__NewCadFileDir* soap_new_set__ns1__NewCadFileDir(soap*, ...) allocate, set all public members
/// - _ns1__NewCadFileDir::soap_default(soap*) default initialize members
/// - int soap_read__ns1__NewCadFileDir(soap*, _ns1__NewCadFileDir*) deserialize from a stream
/// - int soap_write__ns1__NewCadFileDir(soap*, _ns1__NewCadFileDir*) serialize to a stream
/// - _ns1__NewCadFileDir* _ns1__NewCadFileDir::soap_dup(soap*) returns deep copy of _ns1__NewCadFileDir, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__NewCadFileDir::soap_del() deep deletes _ns1__NewCadFileDir data members, use only after _ns1__NewCadFileDir::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__NewCadFileDir::soap_type() returns SOAP_TYPE__ns1__NewCadFileDir or derived type identifier
class _ns1__NewCadFileDir
{ public:
/// Element "UID" of type xs:string.
    std::wstring*                        UID                            0;	///< Optional element.
/// Element "OID" of type xs:string.
    std::wstring*                        OID                            0;	///< Optional element.
/// Element "DrawingDir" of type xs:string.
    std::wstring*                        DrawingDir                     0;	///< Optional element.
/// Element "ParentDirId" of type xs:int.
    int                                  ParentDirId                    1;	///< Required element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};

/// @brief Top-level root element "http://tempuri.org/":NewCadFileDirResponse
/// @brief "http://tempuri.org/":NewCadFileDirResponse is a complexType.
///
/// @note class _ns1__NewCadFileDirResponse operations:
/// - _ns1__NewCadFileDirResponse* soap_new__ns1__NewCadFileDirResponse(soap*) allocate and default initialize
/// - _ns1__NewCadFileDirResponse* soap_new__ns1__NewCadFileDirResponse(soap*, int num) allocate and default initialize an array
/// - _ns1__NewCadFileDirResponse* soap_new_req__ns1__NewCadFileDirResponse(soap*, ...) allocate, set required members
/// - _ns1__NewCadFileDirResponse* soap_new_set__ns1__NewCadFileDirResponse(soap*, ...) allocate, set all public members
/// - _ns1__NewCadFileDirResponse::soap_default(soap*) default initialize members
/// - int soap_read__ns1__NewCadFileDirResponse(soap*, _ns1__NewCadFileDirResponse*) deserialize from a stream
/// - int soap_write__ns1__NewCadFileDirResponse(soap*, _ns1__NewCadFileDirResponse*) serialize to a stream
/// - _ns1__NewCadFileDirResponse* _ns1__NewCadFileDirResponse::soap_dup(soap*) returns deep copy of _ns1__NewCadFileDirResponse, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__NewCadFileDirResponse::soap_del() deep deletes _ns1__NewCadFileDirResponse data members, use only after _ns1__NewCadFileDirResponse::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__NewCadFileDirResponse::soap_type() returns SOAP_TYPE__ns1__NewCadFileDirResponse or derived type identifier
class _ns1__NewCadFileDirResponse
{ public:
/// Element "NewCadFileDirResult" of type xs:string.
    std::wstring*                        NewCadFileDirResult            0;	///< Optional element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};

/// @brief Top-level root element "http://tempuri.org/":DeleteCadFileDir
/// @brief "http://tempuri.org/":DeleteCadFileDir is a complexType.
///
/// @note class _ns1__DeleteCadFileDir operations:
/// - _ns1__DeleteCadFileDir* soap_new__ns1__DeleteCadFileDir(soap*) allocate and default initialize
/// - _ns1__DeleteCadFileDir* soap_new__ns1__DeleteCadFileDir(soap*, int num) allocate and default initialize an array
/// - _ns1__DeleteCadFileDir* soap_new_req__ns1__DeleteCadFileDir(soap*, ...) allocate, set required members
/// - _ns1__DeleteCadFileDir* soap_new_set__ns1__DeleteCadFileDir(soap*, ...) allocate, set all public members
/// - _ns1__DeleteCadFileDir::soap_default(soap*) default initialize members
/// - int soap_read__ns1__DeleteCadFileDir(soap*, _ns1__DeleteCadFileDir*) deserialize from a stream
/// - int soap_write__ns1__DeleteCadFileDir(soap*, _ns1__DeleteCadFileDir*) serialize to a stream
/// - _ns1__DeleteCadFileDir* _ns1__DeleteCadFileDir::soap_dup(soap*) returns deep copy of _ns1__DeleteCadFileDir, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__DeleteCadFileDir::soap_del() deep deletes _ns1__DeleteCadFileDir data members, use only after _ns1__DeleteCadFileDir::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__DeleteCadFileDir::soap_type() returns SOAP_TYPE__ns1__DeleteCadFileDir or derived type identifier
class _ns1__DeleteCadFileDir
{ public:
/// Element "UID" of type xs:string.
    std::wstring*                        UID                            0;	///< Optional element.
...
/// Element "DrawingDir" of type xs:string.
    std::wstring*                        DrawingDir                     0;	///< Optional element.
/// Element "ParentDir" of type xs:string.
    std::wstring*                        ParentDir                      0;	///< Optional element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};

/// @brief Top-level root element "http://tempuri.org/":DeleteCadFileDirResponse
/// @brief "http://tempuri.org/":DeleteCadFileDirResponse is a complexType.
///
/// @note class _ns1__DeleteCadFileDirResponse operations:
/// - _ns1__DeleteCadFileDirResponse* soap_new__ns1__DeleteCadFileDirResponse(soap*) allocate and default initialize
/// - _ns1__DeleteCadFileDirResponse* soap_new__ns1__DeleteCadFileDirResponse(soap*, int num) allocate and default initialize an array
/// - _ns1__DeleteCadFileDirResponse* soap_new_req__ns1__DeleteCadFileDirResponse(soap*, ...) allocate, set required members
/// - _ns1__DeleteCadFileDirResponse* soap_new_set__ns1__DeleteCadFileDirResponse(soap*, ...) allocate, set all public members
/// - _ns1__DeleteCadFileDirResponse::soap_default(soap*) default initialize members
/// - int soap_read__ns1__DeleteCadFileDirResponse(soap*, _ns1__DeleteCadFileDirResponse*) deserialize from a stream
/// - int soap_write__ns1__DeleteCadFileDirResponse(soap*, _ns1__DeleteCadFileDirResponse*) serialize to a stream
/// - _ns1__DeleteCadFileDirResponse* _ns1__DeleteCadFileDirResponse::soap_dup(soap*) returns deep copy of _ns1__DeleteCadFileDirResponse, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__DeleteCadFileDirResponse::soap_del() deep deletes _ns1__DeleteCadFileDirResponse data members, use only after _ns1__DeleteCadFileDirResponse::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__DeleteCadFileDirResponse::soap_type() returns SOAP_TYPE__ns1__DeleteCadFileDirResponse or derived type identifier
class _ns1__DeleteCadFileDirResponse
{ public:
/// Element "DeleteCadFileDirResult" of type xs:string.
    std::wstring*                        DeleteCadFileDirResult         0;	///< Optional element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};

/// @brief Top-level root element "http://tempuri.org/":DeleteCadFileDirByDirId
/// @brief "http://tempuri.org/":DeleteCadFileDirByDirId is a complexType.
///
/// @note class _ns1__DeleteCadFileDirByDirId operations:
/// - _ns1__DeleteCadFileDirByDirId* soap_new__ns1__DeleteCadFileDirByDirId(soap*) allocate and default initialize
/// - _ns1__DeleteCadFileDirByDirId* soap_new__ns1__DeleteCadFileDirByDirId(soap*, int num) allocate and default initialize an array
/// - _ns1__DeleteCadFileDirByDirId* soap_new_req__ns1__DeleteCadFileDirByDirId(soap*, ...) allocate, set required members
/// - _ns1__DeleteCadFileDirByDirId* soap_new_set__ns1__DeleteCadFileDirByDirId(soap*, ...) allocate, set all public members
/// - _ns1__DeleteCadFileDirByDirId::soap_default(soap*) default initialize members
/// - int soap_read__ns1__DeleteCadFileDirByDirId(soap*, _ns1__DeleteCadFileDirByDirId*) deserialize from a stream
/// - int soap_write__ns1__DeleteCadFileDirByDirId(soap*, _ns1__DeleteCadFileDirByDirId*) serialize to a stream
/// - _ns1__DeleteCadFileDirByDirId* _ns1__DeleteCadFileDirByDirId::soap_dup(soap*) returns deep copy of _ns1__DeleteCadFileDirByDirId, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__DeleteCadFileDirByDirId::soap_del() deep deletes _ns1__DeleteCadFileDirByDirId data members, use only after _ns1__DeleteCadFileDirByDirId::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__DeleteCadFileDirByDirId::soap_type() returns SOAP_TYPE__ns1__DeleteCadFileDirByDirId or derived type identifier
class _ns1__DeleteCadFileDirByDirId
{ public:
/// Element "DirId" of type xs:int.
    int                                  DirId                          1;	///< Required element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};

/// @brief Top-level root element "http://tempuri.org/":DeleteCadFileDirByDirIdResponse
/// @brief "http://tempuri.org/":DeleteCadFileDirByDirIdResponse is a complexType.
///
/// @note class _ns1__DeleteCadFileDirByDirIdResponse operations:
/// - _ns1__DeleteCadFileDirByDirIdResponse* soap_new__ns1__DeleteCadFileDirByDirIdResponse(soap*) allocate and default initialize
/// - _ns1__DeleteCadFileDirByDirIdResponse* soap_new__ns1__DeleteCadFileDirByDirIdResponse(soap*, int num) allocate and default initialize an array
/// - _ns1__DeleteCadFileDirByDirIdResponse* soap_new_req__ns1__DeleteCadFileDirByDirIdResponse(soap*, ...) allocate, set required members
/// - _ns1__DeleteCadFileDirByDirIdResponse* soap_new_set__ns1__DeleteCadFileDirByDirIdResponse(soap*, ...) allocate, set all public members
/// - _ns1__DeleteCadFileDirByDirIdResponse::soap_default(soap*) default initialize members
/// - int soap_read__ns1__DeleteCadFileDirByDirIdResponse(soap*, _ns1__DeleteCadFileDirByDirIdResponse*) deserialize from a stream
/// - int soap_write__ns1__DeleteCadFileDirByDirIdResponse(soap*, _ns1__DeleteCadFileDirByDirIdResponse*) serialize to a stream
/// - _ns1__DeleteCadFileDirByDirIdResponse* _ns1__DeleteCadFileDirByDirIdResponse::soap_dup(soap*) returns deep copy of _ns1__DeleteCadFileDirByDirIdResponse, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__DeleteCadFileDirByDirIdResponse::soap_del() deep deletes _ns1__DeleteCadFileDirByDirIdResponse data members, use only after _ns1__DeleteCadFileDirByDirIdResponse::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__DeleteCadFileDirByDirIdResponse::soap_type() returns SOAP_TYPE__ns1__DeleteCadFileDirByDirIdResponse or derived type identifier
class _ns1__DeleteCadFileDirByDirIdResponse
{ public:
/// Element "DeleteCadFileDirByDirIdResult" of type xs:string.
    std::wstring*                        DeleteCadFileDirByDirIdResult  0;	///< Optional element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};

/// @brief Top-level root element "http://tempuri.org/":RenameCadFileDir
/// @brief "http://tempuri.org/":RenameCadFileDir is a complexType.
///
/// @note class _ns1__RenameCadFileDir operations:
/// - _ns1__RenameCadFileDir* soap_new__ns1__RenameCadFileDir(soap*) allocate and default initialize
/// - _ns1__RenameCadFileDir* soap_new__ns1__RenameCadFileDir(soap*, int num) allocate and default initialize an array
/// - _ns1__RenameCadFileDir* soap_new_req__ns1__RenameCadFileDir(soap*, ...) allocate, set required members
/// - _ns1__RenameCadFileDir* soap_new_set__ns1__RenameCadFileDir(soap*, ...) allocate, set all public members
/// - _ns1__RenameCadFileDir::soap_default(soap*) default initialize members
/// - int soap_read__ns1__RenameCadFileDir(soap*, _ns1__RenameCadFileDir*) deserialize from a stream
/// - int soap_write__ns1__RenameCadFileDir(soap*, _ns1__RenameCadFileDir*) serialize to a stream
/// - _ns1__RenameCadFileDir* _ns1__RenameCadFileDir::soap_dup(soap*) returns deep copy of _ns1__RenameCadFileDir, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__RenameCadFileDir::soap_del() deep deletes _ns1__RenameCadFileDir data members, use only after _ns1__RenameCadFileDir::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__RenameCadFileDir::soap_type() returns SOAP_TYPE__ns1__RenameCadFileDir or derived type identifier
class _ns1__RenameCadFileDir
{ public:
/// Element "UID" of type xs:string.
    std::wstring*                        UID                            0;	///< Optional element.
...
/// Element "ParentDirId" of type xs:int.
    int                                  ParentDirId                    1;	///< Required element.
/// Element "NewDrawingDir" of type xs:string.
    std::wstring*                        NewDrawingDir                  0;	///< Optional element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};

/// @brief Top-level root element "http://tempuri.org/":RenameCadFileDirResponse
/// @brief "http://tempuri.org/":RenameCadFileDirResponse is a complexType.
///
/// @note class _ns1__RenameCadFileDirResponse operations:
/// - _ns1__RenameCadFileDirResponse* soap_new__ns1__RenameCadFileDirResponse(soap*) allocate and default initialize
/// - _ns1__RenameCadFileDirResponse* soap_new__ns1__RenameCadFileDirResponse(soap*, int num) allocate and default initialize an array
/// - _ns1__RenameCadFileDirResponse* soap_new_req__ns1__RenameCadFileDirResponse(soap*, ...) allocate, set required members
/// - _ns1__RenameCadFileDirResponse* soap_new_set__ns1__RenameCadFileDirResponse(soap*, ...) allocate, set all public members
/// - _ns1__RenameCadFileDirResponse::soap_default(soap*) default initialize members
/// - int soap_read__ns1__RenameCadFileDirResponse(soap*, _ns1__RenameCadFileDirResponse*) deserialize from a stream
/// - int soap_write__ns1__RenameCadFileDirResponse(soap*, _ns1__RenameCadFileDirResponse*) serialize to a stream
/// - _ns1__RenameCadFileDirResponse* _ns1__RenameCadFileDirResponse::soap_dup(soap*) returns deep copy of _ns1__RenameCadFileDirResponse, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__RenameCadFileDirResponse::soap_del() deep deletes _ns1__RenameCadFileDirResponse data members, use only after _ns1__RenameCadFileDirResponse::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__RenameCadFileDirResponse::soap_type() returns SOAP_TYPE__ns1__RenameCadFileDirResponse or derived type identifier
class _ns1__RenameCadFileDirResponse
{ public:
/// Element "RenameCadFileDirResult" of type xs:string.
    std::wstring*                        RenameCadFileDirResult         0;	///< Optional element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};

/// @brief Top-level root element "http://tempuri.org/":GetProjectInfo
/// @brief "http://tempuri.org/":GetProjectInfo is a complexType.
///
/// @note class _ns1__GetProjectInfo operations:
/// - _ns1__GetProjectInfo* soap_new__ns1__GetProjectInfo(soap*) allocate and default initialize
/// - _ns1__GetProjectInfo* soap_new__ns1__GetProjectInfo(soap*, int num) allocate and default initialize an array
/// - _ns1__GetProjectInfo* soap_new_req__ns1__GetProjectInfo(soap*, ...) allocate, set required members
/// - _ns1__GetProjectInfo* soap_new_set__ns1__GetProjectInfo(soap*, ...) allocate, set all public members
/// - _ns1__GetProjectInfo::soap_default(soap*) default initialize members
/// - int soap_read__ns1__GetProjectInfo(soap*, _ns1__GetProjectInfo*) deserialize from a stream
/// - int soap_write__ns1__GetProjectInfo(soap*, _ns1__GetProjectInfo*) serialize to a stream
/// - _ns1__GetProjectInfo* _ns1__GetProjectInfo::soap_dup(soap*) returns deep copy of _ns1__GetProjectInfo, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__GetProjectInfo::soap_del() deep deletes _ns1__GetProjectInfo data members, use only after _ns1__GetProjectInfo::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__GetProjectInfo::soap_type() returns SOAP_TYPE__ns1__GetProjectInfo or derived type identifier
class _ns1__GetProjectInfo
{ public:
/// Element "UID" of type xs:string.
    std::wstring*                        UID                            0;	///< Optional element.
...
/// @brief Top-level root element "http://tempuri.org/":GetProjectInfoResponse
/// @brief "http://tempuri.org/":GetProjectInfoResponse is a complexType.
///
/// @note class _ns1__GetProjectInfoResponse operations:
/// - _ns1__GetProjectInfoResponse* soap_new__ns1__GetProjectInfoResponse(soap*) allocate and default initialize
/// - _ns1__GetProjectInfoResponse* soap_new__ns1__GetProjectInfoResponse(soap*, int num) allocate and default initialize an array
/// - _ns1__GetProjectInfoResponse* soap_new_req__ns1__GetProjectInfoResponse(soap*, ...) allocate, set required members
/// - _ns1__GetProjectInfoResponse* soap_new_set__ns1__GetProjectInfoResponse(soap*, ...) allocate, set all public members
/// - _ns1__GetProjectInfoResponse::soap_default(soap*) default initialize members
/// - int soap_read__ns1__GetProjectInfoResponse(soap*, _ns1__GetProjectInfoResponse*) deserialize from a stream
/// - int soap_write__ns1__GetProjectInfoResponse(soap*, _ns1__GetProjectInfoResponse*) serialize to a stream
/// - _ns1__GetProjectInfoResponse* _ns1__GetProjectInfoResponse::soap_dup(soap*) returns deep copy of _ns1__GetProjectInfoResponse, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__GetProjectInfoResponse::soap_del() deep deletes _ns1__GetProjectInfoResponse data members, use only after _ns1__GetProjectInfoResponse::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__GetProjectInfoResponse::soap_type() returns SOAP_TYPE__ns1__GetProjectInfoResponse or derived type identifier
class _ns1__GetProjectInfoResponse
{ public:
/// Element "GetProjectInfoResult" of type xs:string.
    std::wstring*                        GetProjectInfoResult           0;	///< Optional element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};

/// @brief Top-level root element "http://tempuri.org/":UpdateCadDrawing
/// @brief "http://tempuri.org/":UpdateCadDrawing is a complexType.
///
/// @note class _ns1__UpdateCadDrawing operations:
/// - _ns1__UpdateCadDrawing* soap_new__ns1__UpdateCadDrawing(soap*) allocate and default initialize
/// - _ns1__UpdateCadDrawing* soap_new__ns1__UpdateCadDrawing(soap*, int num) allocate and default initialize an array
/// - _ns1__UpdateCadDrawing* soap_new_req__ns1__UpdateCadDrawing(soap*, ...) allocate, set required members
/// - _ns1__UpdateCadDrawing* soap_new_set__ns1__UpdateCadDrawing(soap*, ...) allocate, set all public members
/// - _ns1__UpdateCadDrawing::soap_default(soap*) default initialize members
/// - int soap_read__ns1__UpdateCadDrawing(soap*, _ns1__UpdateCadDrawing*) deserialize from a stream
/// - int soap_write__ns1__UpdateCadDrawing(soap*, _ns1__UpdateCadDrawing*) serialize to a stream
/// - _ns1__UpdateCadDrawing* _ns1__UpdateCadDrawing::soap_dup(soap*) returns deep copy of _ns1__UpdateCadDrawing, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__UpdateCadDrawing::soap_del() deep deletes _ns1__UpdateCadDrawing data members, use only after _ns1__UpdateCadDrawing::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__UpdateCadDrawing::soap_type() returns SOAP_TYPE__ns1__UpdateCadDrawing or derived type identifier
class _ns1__UpdateCadDrawing
{ public:
/// Element "UID" of type xs:string.
    std::wstring*                        UID                            0;	///< Optional element.
/// Element "OID" of type xs:string.
    std::wstring*                        OID                            0;	///< Optional element.
/// Element "FileSaveName" of type xs:string.
    std::wstring*                        FileSaveName                   0;	///< Optional element.
/// Element "DrawingFile" of type xs:string.
    std::wstring*                        DrawingFile                    0;	///< Optional element.
/// Element "DrawingDirId" of type xs:int.
    int                                  DrawingDirId                   1;	///< Required element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};

/// @brief Top-level root element "http://tempuri.org/":UpdateCadDrawingResponse
/// @brief "http://tempuri.org/":UpdateCadDrawingResponse is a complexType.
///
/// @note class _ns1__UpdateCadDrawingResponse operations:
/// - _ns1__UpdateCadDrawingResponse* soap_new__ns1__UpdateCadDrawingResponse(soap*) allocate and default initialize
/// - _ns1__UpdateCadDrawingResponse* soap_new__ns1__UpdateCadDrawingResponse(soap*, int num) allocate and default initialize an array
/// - _ns1__UpdateCadDrawingResponse* soap_new_req__ns1__UpdateCadDrawingResponse(soap*, ...) allocate, set required members
/// - _ns1__UpdateCadDrawingResponse* soap_new_set__ns1__UpdateCadDrawingResponse(soap*, ...) allocate, set all public members
/// - _ns1__UpdateCadDrawingResponse::soap_default(soap*) default initialize members
/// - int soap_read__ns1__UpdateCadDrawingResponse(soap*, _ns1__UpdateCadDrawingResponse*) deserialize from a stream
/// - int soap_write__ns1__UpdateCadDrawingResponse(soap*, _ns1__UpdateCadDrawingResponse*) serialize to a stream
/// - _ns1__UpdateCadDrawingResponse* _ns1__UpdateCadDrawingResponse::soap_dup(soap*) returns deep copy of _ns1__UpdateCadDrawingResponse, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__UpdateCadDrawingResponse::soap_del() deep deletes _ns1__UpdateCadDrawingResponse data members, use only after _ns1__UpdateCadDrawingResponse::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__UpdateCadDrawingResponse::soap_type() returns SOAP_TYPE__ns1__UpdateCadDrawingResponse or derived type identifier
class _ns1__UpdateCadDrawingResponse
{ public:
/// Element "UpdateCadDrawingResult" of type xs:string.
    std::wstring*                        UpdateCadDrawingResult         0;	///< Optional element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};

/// @brief Top-level root element "http://tempuri.org/":DeleteCadDrawing
/// @brief "http://tempuri.org/":DeleteCadDrawing is a complexType.
///
/// @note class _ns1__DeleteCadDrawing operations:
/// - _ns1__DeleteCadDrawing* soap_new__ns1__DeleteCadDrawing(soap*) allocate and default initialize
/// - _ns1__DeleteCadDrawing* soap_new__ns1__DeleteCadDrawing(soap*, int num) allocate and default initialize an array
/// - _ns1__DeleteCadDrawing* soap_new_req__ns1__DeleteCadDrawing(soap*, ...) allocate, set required members
/// - _ns1__DeleteCadDrawing* soap_new_set__ns1__DeleteCadDrawing(soap*, ...) allocate, set all public members
/// - _ns1__DeleteCadDrawing::soap_default(soap*) default initialize members
/// - int soap_read__ns1__DeleteCadDrawing(soap*, _ns1__DeleteCadDrawing*) deserialize from a stream
/// - int soap_write__ns1__DeleteCadDrawing(soap*, _ns1__DeleteCadDrawing*) serialize to a stream
/// - _ns1__DeleteCadDrawing* _ns1__DeleteCadDrawing::soap_dup(soap*) returns deep copy of _ns1__DeleteCadDrawing, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__DeleteCadDrawing::soap_del() deep deletes _ns1__DeleteCadDrawing data members, use only after _ns1__DeleteCadDrawing::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__DeleteCadDrawing::soap_type() returns SOAP_TYPE__ns1__DeleteCadDrawing or derived type identifier
class _ns1__DeleteCadDrawing
{ public:
/// Element "UID" of type xs:string.
    std::wstring*                        UID                            0;	///< Optional element.
...
/// @brief Top-level root element "http://tempuri.org/":DeleteCadDrawingResponse
/// @brief "http://tempuri.org/":DeleteCadDrawingResponse is a complexType.
///
/// @note class _ns1__DeleteCadDrawingResponse operations:
/// - _ns1__DeleteCadDrawingResponse* soap_new__ns1__DeleteCadDrawingResponse(soap*) allocate and default initialize
/// - _ns1__DeleteCadDrawingResponse* soap_new__ns1__DeleteCadDrawingResponse(soap*, int num) allocate and default initialize an array
/// - _ns1__DeleteCadDrawingResponse* soap_new_req__ns1__DeleteCadDrawingResponse(soap*, ...) allocate, set required members
/// - _ns1__DeleteCadDrawingResponse* soap_new_set__ns1__DeleteCadDrawingResponse(soap*, ...) allocate, set all public members
/// - _ns1__DeleteCadDrawingResponse::soap_default(soap*) default initialize members
/// - int soap_read__ns1__DeleteCadDrawingResponse(soap*, _ns1__DeleteCadDrawingResponse*) deserialize from a stream
/// - int soap_write__ns1__DeleteCadDrawingResponse(soap*, _ns1__DeleteCadDrawingResponse*) serialize to a stream
/// - _ns1__DeleteCadDrawingResponse* _ns1__DeleteCadDrawingResponse::soap_dup(soap*) returns deep copy of _ns1__DeleteCadDrawingResponse, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__DeleteCadDrawingResponse::soap_del() deep deletes _ns1__DeleteCadDrawingResponse data members, use only after _ns1__DeleteCadDrawingResponse::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__DeleteCadDrawingResponse::soap_type() returns SOAP_TYPE__ns1__DeleteCadDrawingResponse or derived type identifier
class _ns1__DeleteCadDrawingResponse
{ public:
/// Element "DeleteCadDrawingResult" of type xs:string.
    std::wstring*                        DeleteCadDrawingResult         0;	///< Optional element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};

/// @brief Top-level root element "http://tempuri.org/":DeleteCadDrawingByFileID
/// @brief "http://tempuri.org/":DeleteCadDrawingByFileID is a complexType.
///
/// @note class _ns1__DeleteCadDrawingByFileID operations:
/// - _ns1__DeleteCadDrawingByFileID* soap_new__ns1__DeleteCadDrawingByFileID(soap*) allocate and default initialize
/// - _ns1__DeleteCadDrawingByFileID* soap_new__ns1__DeleteCadDrawingByFileID(soap*, int num) allocate and default initialize an array
/// - _ns1__DeleteCadDrawingByFileID* soap_new_req__ns1__DeleteCadDrawingByFileID(soap*, ...) allocate, set required members
/// - _ns1__DeleteCadDrawingByFileID* soap_new_set__ns1__DeleteCadDrawingByFileID(soap*, ...) allocate, set all public members
/// - _ns1__DeleteCadDrawingByFileID::soap_default(soap*) default initialize members
/// - int soap_read__ns1__DeleteCadDrawingByFileID(soap*, _ns1__DeleteCadDrawingByFileID*) deserialize from a stream
/// - int soap_write__ns1__DeleteCadDrawingByFileID(soap*, _ns1__DeleteCadDrawingByFileID*) serialize to a stream
/// - _ns1__DeleteCadDrawingByFileID* _ns1__DeleteCadDrawingByFileID::soap_dup(soap*) returns deep copy of _ns1__DeleteCadDrawingByFileID, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__DeleteCadDrawingByFileID::soap_del() deep deletes _ns1__DeleteCadDrawingByFileID data members, use only after _ns1__DeleteCadDrawingByFileID::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__DeleteCadDrawingByFileID::soap_type() returns SOAP_TYPE__ns1__DeleteCadDrawingByFileID or derived type identifier
class _ns1__DeleteCadDrawingByFileID
{ public:
/// Element "FileID" of type xs:int.
    int                                  FileID                         1;	///< Required element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};

/// @brief Top-level root element "http://tempuri.org/":DeleteCadDrawingByFileIDResponse
/// @brief "http://tempuri.org/":DeleteCadDrawingByFileIDResponse is a complexType.
///
/// @note class _ns1__DeleteCadDrawingByFileIDResponse operations:
/// - _ns1__DeleteCadDrawingByFileIDResponse* soap_new__ns1__DeleteCadDrawingByFileIDResponse(soap*) allocate and default initialize
/// - _ns1__DeleteCadDrawingByFileIDResponse* soap_new__ns1__DeleteCadDrawingByFileIDResponse(soap*, int num) allocate and default initialize an array
/// - _ns1__DeleteCadDrawingByFileIDResponse* soap_new_req__ns1__DeleteCadDrawingByFileIDResponse(soap*, ...) allocate, set required members
/// - _ns1__DeleteCadDrawingByFileIDResponse* soap_new_set__ns1__DeleteCadDrawingByFileIDResponse(soap*, ...) allocate, set all public members
/// - _ns1__DeleteCadDrawingByFileIDResponse::soap_default(soap*) default initialize members
/// - int soap_read__ns1__DeleteCadDrawingByFileIDResponse(soap*, _ns1__DeleteCadDrawingByFileIDResponse*) deserialize from a stream
/// - int soap_write__ns1__DeleteCadDrawingByFileIDResponse(soap*, _ns1__DeleteCadDrawingByFileIDResponse*) serialize to a stream
/// - _ns1__DeleteCadDrawingByFileIDResponse* _ns1__DeleteCadDrawingByFileIDResponse::soap_dup(soap*) returns deep copy of _ns1__DeleteCadDrawingByFileIDResponse, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__DeleteCadDrawingByFileIDResponse::soap_del() deep deletes _ns1__DeleteCadDrawingByFileIDResponse data members, use only after _ns1__DeleteCadDrawingByFileIDResponse::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__DeleteCadDrawingByFileIDResponse::soap_type() returns SOAP_TYPE__ns1__DeleteCadDrawingByFileIDResponse or derived type identifier
class _ns1__DeleteCadDrawingByFileIDResponse
{ public:
/// Element "DeleteCadDrawingByFileIDResult" of type xs:string.
    std::wstring*                        DeleteCadDrawingByFileIDResult 0;	///< Optional element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};

/// @brief Top-level root element "http://tempuri.org/":CheckUserInfo
/// @brief "http://tempuri.org/":CheckUserInfo is a complexType.
///
/// @note class _ns1__CheckUserInfo operations:
/// - _ns1__CheckUserInfo* soap_new__ns1__CheckUserInfo(soap*) allocate and default initialize
/// - _ns1__CheckUserInfo* soap_new__ns1__CheckUserInfo(soap*, int num) allocate and default initialize an array
/// - _ns1__CheckUserInfo* soap_new_req__ns1__CheckUserInfo(soap*, ...) allocate, set required members
/// - _ns1__CheckUserInfo* soap_new_set__ns1__CheckUserInfo(soap*, ...) allocate, set all public members
/// - _ns1__CheckUserInfo::soap_default(soap*) default initialize members
/// - int soap_read__ns1__CheckUserInfo(soap*, _ns1__CheckUserInfo*) deserialize from a stream
/// - int soap_write__ns1__CheckUserInfo(soap*, _ns1__CheckUserInfo*) serialize to a stream
/// - _ns1__CheckUserInfo* _ns1__CheckUserInfo::soap_dup(soap*) returns deep copy of _ns1__CheckUserInfo, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__CheckUserInfo::soap_del() deep deletes _ns1__CheckUserInfo data members, use only after _ns1__CheckUserInfo::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__CheckUserInfo::soap_type() returns SOAP_TYPE__ns1__CheckUserInfo or derived type identifier
class _ns1__CheckUserInfo
{ public:
...
/// @brief Top-level root element "http://tempuri.org/":CheckUserInfoResponse
/// @brief "http://tempuri.org/":CheckUserInfoResponse is a complexType.
///
/// @note class _ns1__CheckUserInfoResponse operations:
/// - _ns1__CheckUserInfoResponse* soap_new__ns1__CheckUserInfoResponse(soap*) allocate and default initialize
/// - _ns1__CheckUserInfoResponse* soap_new__ns1__CheckUserInfoResponse(soap*, int num) allocate and default initialize an array
/// - _ns1__CheckUserInfoResponse* soap_new_req__ns1__CheckUserInfoResponse(soap*, ...) allocate, set required members
/// - _ns1__CheckUserInfoResponse* soap_new_set__ns1__CheckUserInfoResponse(soap*, ...) allocate, set all public members
/// - _ns1__CheckUserInfoResponse::soap_default(soap*) default initialize members
/// - int soap_read__ns1__CheckUserInfoResponse(soap*, _ns1__CheckUserInfoResponse*) deserialize from a stream
/// - int soap_write__ns1__CheckUserInfoResponse(soap*, _ns1__CheckUserInfoResponse*) serialize to a stream
/// - _ns1__CheckUserInfoResponse* _ns1__CheckUserInfoResponse::soap_dup(soap*) returns deep copy of _ns1__CheckUserInfoResponse, copies the (cyclic) graph structure when a context is provided, or (cycle-pruned) tree structure with soap_set_mode(soap, SOAP_XML_TREE) (use soapcpp2 -Ec)
/// - _ns1__CheckUserInfoResponse::soap_del() deep deletes _ns1__CheckUserInfoResponse data members, use only after _ns1__CheckUserInfoResponse::soap_dup(NULL) (use soapcpp2 -Ed)
/// - int _ns1__CheckUserInfoResponse::soap_type() returns SOAP_TYPE__ns1__CheckUserInfoResponse or derived type identifier
class _ns1__CheckUserInfoResponse
{ public:
/// Element "CheckUserInfoResult" of type xs:string.
    std::wstring*                        CheckUserInfoResult            0;	///< Optional element.
/// Pointer to soap context that manages this instance.
    struct soap                         *soap                          ;
};
...
//gsoap ns1  service port:	http://des.sunac.com.cn/SunacCADService.asmx 
...
@section ArgumentSettingServiceSoap_operations Operations of Binding "ArgumentSettingServiceSoap"
  ...
  - @ref __ns1__NewCadFileDir

  - @ref __ns1__DeleteCadFileDir

  - @ref __ns1__DeleteCadFileDirByDirId

  - @ref __ns1__RenameCadFileDir

  - @ref __ns1__GetProjectInfo

  - @ref __ns1__UpdateCadDrawing

  - @ref __ns1__DeleteCadDrawing

  - @ref __ns1__DeleteCadDrawingByFileID

  - @ref __ns1__CheckUserInfo
  ...
  - @ref __ns1__NewCadFileDir_

  - @ref __ns1__DeleteCadFileDir_

  - @ref __ns1__DeleteCadFileDirByDirId_

  - @ref __ns1__RenameCadFileDir_

  - @ref __ns1__GetProjectInfo_

  - @ref __ns1__UpdateCadDrawing_

  - @ref __ns1__DeleteCadDrawing_

  - @ref __ns1__DeleteCadDrawingByFileID_

  - @ref __ns1__CheckUserInfo_

@section ArgumentSettingServiceSoap_ports Default endpoints of Binding "ArgumentSettingServiceSoap"

  - http://des.sunac.com.cn/SunacCADService.asmx
 ...
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__NewCadFileDir                                                     *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__NewCadFileDir" of service binding "ArgumentSettingServiceSoap".
  ...
  - Default SOAP action or REST location path:
    - "http://tempuri.org/NewCadFileDir"

  - Addressing input action: "http://tempuri.org/NewCadFileDir"

  - Addressing output action: "http://tempuri.org/NewCadFileDirResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__NewCadFileDir(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
    ...
    // output parameters:
    _ns1__NewCadFileDirResponse        &ns1__NewCadFileDirResponse
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__NewCadFileDir(
    struct soap *soap,
    // input parameters:
    _ns1__NewCadFileDir*                ns1__NewCadFileDir,
    // output parameters:
...
//gsoap ns1  service method-protocol:	NewCadFileDir SOAP
//gsoap ns1  service method-style:	NewCadFileDir document
//gsoap ns1  service method-encoding:	NewCadFileDir literal
//gsoap ns1  service method-input-action:	NewCadFileDir http://tempuri.org/NewCadFileDir
//gsoap ns1  service method-output-action:	NewCadFileDir http://tempuri.org/NewCadFileDirResponse
int __ns1__NewCadFileDir(
    _ns1__NewCadFileDir*                ns1__NewCadFileDir,	///< Input parameter
    _ns1__NewCadFileDirResponse        &ns1__NewCadFileDirResponse	///< Output parameter
);

/******************************************************************************\
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__DeleteCadFileDir                                                  *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__DeleteCadFileDir" of service binding "ArgumentSettingServiceSoap".
  ...
  - Default SOAP action or REST location path:
    - "http://tempuri.org/DeleteCadFileDir"

  - Addressing input action: "http://tempuri.org/DeleteCadFileDir"

  - Addressing output action: "http://tempuri.org/DeleteCadFileDirResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__DeleteCadFileDir(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
    ...
    // output parameters:
    _ns1__DeleteCadFileDirResponse     &ns1__DeleteCadFileDirResponse
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__DeleteCadFileDir(
    struct soap *soap,
    // input parameters:
    _ns1__DeleteCadFileDir*             ns1__DeleteCadFileDir,
    // output parameters:
...
//gsoap ns1  service method-protocol:	DeleteCadFileDir SOAP
//gsoap ns1  service method-style:	DeleteCadFileDir document
//gsoap ns1  service method-encoding:	DeleteCadFileDir literal
//gsoap ns1  service method-input-action:	DeleteCadFileDir http://tempuri.org/DeleteCadFileDir
//gsoap ns1  service method-output-action:	DeleteCadFileDir http://tempuri.org/DeleteCadFileDirResponse
int __ns1__DeleteCadFileDir(
    _ns1__DeleteCadFileDir*             ns1__DeleteCadFileDir,	///< Input parameter
    _ns1__DeleteCadFileDirResponse     &ns1__DeleteCadFileDirResponse	///< Output parameter
);

/******************************************************************************\
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__DeleteCadFileDirByDirId                                           *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__DeleteCadFileDirByDirId" of service binding "ArgumentSettingServiceSoap".
[ID]
  ...
  - Default SOAP action or REST location path:
    - "http://tempuri.org/DeleteCadFileDirByDirId"

  - Addressing input action: "http://tempuri.org/DeleteCadFileDirByDirId"

  - Addressing output action: "http://tempuri.org/DeleteCadFileDirByDirIdResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__DeleteCadFileDirByDirId(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
    ...
    // output parameters:
    _ns1__DeleteCadFileDirByDirIdResponse&ns1__DeleteCadFileDirByDirIdResponse
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__DeleteCadFileDirByDirId(
    struct soap *soap,
    // input parameters:
    _ns1__DeleteCadFileDirByDirId*      ns1__DeleteCadFileDirByDirId,
    // output parameters:
...
//gsoap ns1  service method-protocol:	DeleteCadFileDirByDirId SOAP
//gsoap ns1  service method-style:	DeleteCadFileDirByDirId document
//gsoap ns1  service method-encoding:	DeleteCadFileDirByDirId literal
//gsoap ns1  service method-input-action:	DeleteCadFileDirByDirId http://tempuri.org/DeleteCadFileDirByDirId
//gsoap ns1  service method-output-action:	DeleteCadFileDirByDirId http://tempuri.org/DeleteCadFileDirByDirIdResponse
int __ns1__DeleteCadFileDirByDirId(
    _ns1__DeleteCadFileDirByDirId*      ns1__DeleteCadFileDirByDirId,	///< Input parameter
    _ns1__DeleteCadFileDirByDirIdResponse&ns1__DeleteCadFileDirByDirIdResponse	///< Output parameter
);

/******************************************************************************\
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__RenameCadFileDir                                                  *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__RenameCadFileDir" of service binding "ArgumentSettingServiceSoap".
  ...
  - Default SOAP action or REST location path:
    - "http://tempuri.org/RenameCadFileDir"

  - Addressing input action: "http://tempuri.org/RenameCadFileDir"

  - Addressing output action: "http://tempuri.org/RenameCadFileDirResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__RenameCadFileDir(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
    ...
    // output parameters:
    _ns1__RenameCadFileDirResponse     &ns1__RenameCadFileDirResponse
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__RenameCadFileDir(
    struct soap *soap,
    // input parameters:
    _ns1__RenameCadFileDir*             ns1__RenameCadFileDir,
    // output parameters:
...
//gsoap ns1  service method-protocol:	RenameCadFileDir SOAP
//gsoap ns1  service method-style:	RenameCadFileDir document
//gsoap ns1  service method-encoding:	RenameCadFileDir literal
//gsoap ns1  service method-input-action:	RenameCadFileDir http://tempuri.org/RenameCadFileDir
//gsoap ns1  service method-output-action:	RenameCadFileDir http://tempuri.org/RenameCadFileDirResponse
int __ns1__RenameCadFileDir(
    _ns1__RenameCadFileDir*             ns1__RenameCadFileDir,	///< Input parameter
    _ns1__RenameCadFileDirResponse     &ns1__RenameCadFileDirResponse	///< Output parameter
);

/******************************************************************************\
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__GetProjectInfo                                                    *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__GetProjectInfo" of service binding "ArgumentSettingServiceSoap".
  ...
  - Default SOAP action or REST location path:
    - "http://tempuri.org/GetProjectInfo"

  - Addressing input action: "http://tempuri.org/GetProjectInfo"

  - Addressing output action: "http://tempuri.org/GetProjectInfoResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__GetProjectInfo(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
    ...
    // output parameters:
    _ns1__GetProjectInfoResponse       &ns1__GetProjectInfoResponse
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__GetProjectInfo(
    struct soap *soap,
    // input parameters:
    _ns1__GetProjectInfo*               ns1__GetProjectInfo,
    // output parameters:
...
//gsoap ns1  service method-protocol:	GetProjectInfo SOAP
//gsoap ns1  service method-style:	GetProjectInfo document
//gsoap ns1  service method-encoding:	GetProjectInfo literal
//gsoap ns1  service method-input-action:	GetProjectInfo http://tempuri.org/GetProjectInfo
//gsoap ns1  service method-output-action:	GetProjectInfo http://tempuri.org/GetProjectInfoResponse
int __ns1__GetProjectInfo(
    _ns1__GetProjectInfo*               ns1__GetProjectInfo,	///< Input parameter
    _ns1__GetProjectInfoResponse       &ns1__GetProjectInfoResponse	///< Output parameter
);

/******************************************************************************\
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__UpdateCadDrawing                                                  *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__UpdateCadDrawing" of service binding "ArgumentSettingServiceSoap".
  ...
  - Default SOAP action or REST location path:
    - "http://tempuri.org/UpdateCadDrawing"

  - Addressing input action: "http://tempuri.org/UpdateCadDrawing"

  - Addressing output action: "http://tempuri.org/UpdateCadDrawingResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__UpdateCadDrawing(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
    ...
    // output parameters:
    _ns1__UpdateCadDrawingResponse     &ns1__UpdateCadDrawingResponse
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__UpdateCadDrawing(
    struct soap *soap,
    // input parameters:
    _ns1__UpdateCadDrawing*             ns1__UpdateCadDrawing,
    // output parameters:
...
//gsoap ns1  service method-protocol:	UpdateCadDrawing SOAP
//gsoap ns1  service method-style:	UpdateCadDrawing document
//gsoap ns1  service method-encoding:	UpdateCadDrawing literal
//gsoap ns1  service method-input-action:	UpdateCadDrawing http://tempuri.org/UpdateCadDrawing
//gsoap ns1  service method-output-action:	UpdateCadDrawing http://tempuri.org/UpdateCadDrawingResponse
int __ns1__UpdateCadDrawing(
    _ns1__UpdateCadDrawing*             ns1__UpdateCadDrawing,	///< Input parameter
    _ns1__UpdateCadDrawingResponse     &ns1__UpdateCadDrawingResponse	///< Output parameter
);

/******************************************************************************\
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__DeleteCadDrawing                                                  *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__DeleteCadDrawing" of service binding "ArgumentSettingServiceSoap".
  ...
  - Default SOAP action or REST location path:
    - "http://tempuri.org/DeleteCadDrawing"

  - Addressing input action: "http://tempuri.org/DeleteCadDrawing"

  - Addressing output action: "http://tempuri.org/DeleteCadDrawingResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__DeleteCadDrawing(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
    ...
    // output parameters:
    _ns1__DeleteCadDrawingResponse     &ns1__DeleteCadDrawingResponse
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__DeleteCadDrawing(
    struct soap *soap,
    // input parameters:
    _ns1__DeleteCadDrawing*             ns1__DeleteCadDrawing,
    // output parameters:
...
//gsoap ns1  service method-protocol:	DeleteCadDrawing SOAP
//gsoap ns1  service method-style:	DeleteCadDrawing document
//gsoap ns1  service method-encoding:	DeleteCadDrawing literal
//gsoap ns1  service method-input-action:	DeleteCadDrawing http://tempuri.org/DeleteCadDrawing
//gsoap ns1  service method-output-action:	DeleteCadDrawing http://tempuri.org/DeleteCadDrawingResponse
int __ns1__DeleteCadDrawing(
    _ns1__DeleteCadDrawing*             ns1__DeleteCadDrawing,	///< Input parameter
    _ns1__DeleteCadDrawingResponse     &ns1__DeleteCadDrawingResponse	///< Output parameter
);

/******************************************************************************\
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__DeleteCadDrawingByFileID                                          *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__DeleteCadDrawingByFileID" of service binding "ArgumentSettingServiceSoap".
ID
  ...
  - Default SOAP action or REST location path:
    - "http://tempuri.org/DeleteCadDrawingByFileID"

  - Addressing input action: "http://tempuri.org/DeleteCadDrawingByFileID"

  - Addressing output action: "http://tempuri.org/DeleteCadDrawingByFileIDResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__DeleteCadDrawingByFileID(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
    ...
    // output parameters:
    _ns1__DeleteCadDrawingByFileIDResponse&ns1__DeleteCadDrawingByFileIDResponse
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__DeleteCadDrawingByFileID(
    struct soap *soap,
    // input parameters:
    _ns1__DeleteCadDrawingByFileID*     ns1__DeleteCadDrawingByFileID,
    // output parameters:
...
//gsoap ns1  service method-protocol:	DeleteCadDrawingByFileID SOAP
//gsoap ns1  service method-style:	DeleteCadDrawingByFileID document
//gsoap ns1  service method-encoding:	DeleteCadDrawingByFileID literal
//gsoap ns1  service method-input-action:	DeleteCadDrawingByFileID http://tempuri.org/DeleteCadDrawingByFileID
//gsoap ns1  service method-output-action:	DeleteCadDrawingByFileID http://tempuri.org/DeleteCadDrawingByFileIDResponse
int __ns1__DeleteCadDrawingByFileID(
    _ns1__DeleteCadDrawingByFileID*     ns1__DeleteCadDrawingByFileID,	///< Input parameter
    _ns1__DeleteCadDrawingByFileIDResponse&ns1__DeleteCadDrawingByFileIDResponse	///< Output parameter
);

/******************************************************************************\
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__CheckUserInfo                                                     *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__CheckUserInfo" of service binding "ArgumentSettingServiceSoap".
  ...
  - Default SOAP action or REST location path:
    - "http://tempuri.org/CheckUserInfo"

  - Addressing input action: "http://tempuri.org/CheckUserInfo"

  - Addressing output action: "http://tempuri.org/CheckUserInfoResponse"

C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__CheckUserInfo(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
    ...
    // output parameters:
    _ns1__CheckUserInfoResponse        &ns1__CheckUserInfoResponse
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__CheckUserInfo(
    struct soap *soap,
    // input parameters:
    _ns1__CheckUserInfo*                ns1__CheckUserInfo,
    // output parameters:
...
//gsoap ns1  service method-protocol:	CheckUserInfo SOAP
//gsoap ns1  service method-style:	CheckUserInfo document
//gsoap ns1  service method-encoding:	CheckUserInfo literal
//gsoap ns1  service method-input-action:	CheckUserInfo http://tempuri.org/CheckUserInfo
//gsoap ns1  service method-output-action:	CheckUserInfo http://tempuri.org/CheckUserInfoResponse
int __ns1__CheckUserInfo(
    _ns1__CheckUserInfo*                ns1__CheckUserInfo,	///< Input parameter
    _ns1__CheckUserInfoResponse        &ns1__CheckUserInfoResponse	///< Output parameter
);
 ...
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__NewCadFileDir_                                                    *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__NewCadFileDir_" of service binding "ArgumentSettingServiceSoap".
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__NewCadFileDir_(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
//gsoap ns1  service method-protocol:	NewCadFileDir_ SOAP
//gsoap ns1  service method-style:	NewCadFileDir_ document
//gsoap ns1  service method-encoding:	NewCadFileDir_ literal
//gsoap ns1  service method-input-action:	NewCadFileDir_ http://tempuri.org/NewCadFileDir
//gsoap ns1  service method-output-action:	NewCadFileDir_ http://tempuri.org/NewCadFileDirResponse
int __ns1__NewCadFileDir_(
    _ns1__NewCadFileDir*                ns1__NewCadFileDir,	///< Input parameter
    _ns1__NewCadFileDirResponse        &ns1__NewCadFileDirResponse	///< Output parameter
);
 ...
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__DeleteCadFileDir_                                                 *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__DeleteCadFileDir_" of service binding "ArgumentSettingServiceSoap".
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__DeleteCadFileDir_(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
//gsoap ns1  service method-protocol:	DeleteCadFileDir_ SOAP
//gsoap ns1  service method-style:	DeleteCadFileDir_ document
//gsoap ns1  service method-encoding:	DeleteCadFileDir_ literal
//gsoap ns1  service method-input-action:	DeleteCadFileDir_ http://tempuri.org/DeleteCadFileDir
//gsoap ns1  service method-output-action:	DeleteCadFileDir_ http://tempuri.org/DeleteCadFileDirResponse
int __ns1__DeleteCadFileDir_(
    _ns1__DeleteCadFileDir*             ns1__DeleteCadFileDir,	///< Input parameter
    _ns1__DeleteCadFileDirResponse     &ns1__DeleteCadFileDirResponse	///< Output parameter
);
 ...
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__DeleteCadFileDirByDirId_                                          *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__DeleteCadFileDirByDirId_" of service binding "ArgumentSettingServiceSoap".
[ID]
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__DeleteCadFileDirByDirId_(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__DeleteCadFileDirByDirId_(
    struct soap *soap,
    // input parameters:
    _ns1__DeleteCadFileDirByDirId*      ns1__DeleteCadFileDirByDirId,
    // output parameters:
...
//gsoap ns1  service method-protocol:	DeleteCadFileDirByDirId_ SOAP
//gsoap ns1  service method-style:	DeleteCadFileDirByDirId_ document
//gsoap ns1  service method-encoding:	DeleteCadFileDirByDirId_ literal
//gsoap ns1  service method-input-action:	DeleteCadFileDirByDirId_ http://tempuri.org/DeleteCadFileDirByDirId
//gsoap ns1  service method-output-action:	DeleteCadFileDirByDirId_ http://tempuri.org/DeleteCadFileDirByDirIdResponse
int __ns1__DeleteCadFileDirByDirId_(
    _ns1__DeleteCadFileDirByDirId*      ns1__DeleteCadFileDirByDirId,	///< Input parameter
    _ns1__DeleteCadFileDirByDirIdResponse&ns1__DeleteCadFileDirByDirIdResponse	///< Output parameter
);
 ...
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__RenameCadFileDir_                                                 *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__RenameCadFileDir_" of service binding "ArgumentSettingServiceSoap".
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__RenameCadFileDir_(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
//gsoap ns1  service method-protocol:	RenameCadFileDir_ SOAP
//gsoap ns1  service method-style:	RenameCadFileDir_ document
//gsoap ns1  service method-encoding:	RenameCadFileDir_ literal
//gsoap ns1  service method-input-action:	RenameCadFileDir_ http://tempuri.org/RenameCadFileDir
//gsoap ns1  service method-output-action:	RenameCadFileDir_ http://tempuri.org/RenameCadFileDirResponse
int __ns1__RenameCadFileDir_(
    _ns1__RenameCadFileDir*             ns1__RenameCadFileDir,	///< Input parameter
    _ns1__RenameCadFileDirResponse     &ns1__RenameCadFileDirResponse	///< Output parameter
);
 ...
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__GetProjectInfo_                                                   *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__GetProjectInfo_" of service binding "ArgumentSettingServiceSoap".
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__GetProjectInfo_(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
//gsoap ns1  service method-protocol:	GetProjectInfo_ SOAP
//gsoap ns1  service method-style:	GetProjectInfo_ document
//gsoap ns1  service method-encoding:	GetProjectInfo_ literal
//gsoap ns1  service method-input-action:	GetProjectInfo_ http://tempuri.org/GetProjectInfo
//gsoap ns1  service method-output-action:	GetProjectInfo_ http://tempuri.org/GetProjectInfoResponse
int __ns1__GetProjectInfo_(
    _ns1__GetProjectInfo*               ns1__GetProjectInfo,	///< Input parameter
    _ns1__GetProjectInfoResponse       &ns1__GetProjectInfoResponse	///< Output parameter
);
 ...
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__UpdateCadDrawing_                                                 *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__UpdateCadDrawing_" of service binding "ArgumentSettingServiceSoap".
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__UpdateCadDrawing_(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
//gsoap ns1  service method-protocol:	UpdateCadDrawing_ SOAP
//gsoap ns1  service method-style:	UpdateCadDrawing_ document
//gsoap ns1  service method-encoding:	UpdateCadDrawing_ literal
//gsoap ns1  service method-input-action:	UpdateCadDrawing_ http://tempuri.org/UpdateCadDrawing
//gsoap ns1  service method-output-action:	UpdateCadDrawing_ http://tempuri.org/UpdateCadDrawingResponse
int __ns1__UpdateCadDrawing_(
    _ns1__UpdateCadDrawing*             ns1__UpdateCadDrawing,	///< Input parameter
    _ns1__UpdateCadDrawingResponse     &ns1__UpdateCadDrawingResponse	///< Output parameter
);
 ...
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__DeleteCadDrawing_                                                 *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__DeleteCadDrawing_" of service binding "ArgumentSettingServiceSoap".
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__DeleteCadDrawing_(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
//gsoap ns1  service method-protocol:	DeleteCadDrawing_ SOAP
//gsoap ns1  service method-style:	DeleteCadDrawing_ document
//gsoap ns1  service method-encoding:	DeleteCadDrawing_ literal
//gsoap ns1  service method-input-action:	DeleteCadDrawing_ http://tempuri.org/DeleteCadDrawing
//gsoap ns1  service method-output-action:	DeleteCadDrawing_ http://tempuri.org/DeleteCadDrawingResponse
int __ns1__DeleteCadDrawing_(
    _ns1__DeleteCadDrawing*             ns1__DeleteCadDrawing,	///< Input parameter
    _ns1__DeleteCadDrawingResponse     &ns1__DeleteCadDrawingResponse	///< Output parameter
);
 ...
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__DeleteCadDrawingByFileID_                                         *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__DeleteCadDrawingByFileID_" of service binding "ArgumentSettingServiceSoap".
ID
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__DeleteCadDrawingByFileID_(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__DeleteCadDrawingByFileID_(
    struct soap *soap,
    // input parameters:
    _ns1__DeleteCadDrawingByFileID*     ns1__DeleteCadDrawingByFileID,
    // output parameters:
...
//gsoap ns1  service method-protocol:	DeleteCadDrawingByFileID_ SOAP
//gsoap ns1  service method-style:	DeleteCadDrawingByFileID_ document
//gsoap ns1  service method-encoding:	DeleteCadDrawingByFileID_ literal
//gsoap ns1  service method-input-action:	DeleteCadDrawingByFileID_ http://tempuri.org/DeleteCadDrawingByFileID
//gsoap ns1  service method-output-action:	DeleteCadDrawingByFileID_ http://tempuri.org/DeleteCadDrawingByFileIDResponse
int __ns1__DeleteCadDrawingByFileID_(
    _ns1__DeleteCadDrawingByFileID*     ns1__DeleteCadDrawingByFileID,	///< Input parameter
    _ns1__DeleteCadDrawingByFileIDResponse&ns1__DeleteCadDrawingByFileIDResponse	///< Output parameter
);
 ...
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__CheckUserInfo_                                                    *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__CheckUserInfo_" of service binding "ArgumentSettingServiceSoap".
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__CheckUserInfo_(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
...
//gsoap ns1  service method-protocol:	CheckUserInfo_ SOAP
//gsoap ns1  service method-style:	CheckUserInfo_ document
//gsoap ns1  service method-encoding:	CheckUserInfo_ literal
//gsoap ns1  service method-input-action:	CheckUserInfo_ http://tempuri.org/CheckUserInfo
//gsoap ns1  service method-output-action:	CheckUserInfo_ http://tempuri.org/CheckUserInfoResponse
int __ns1__CheckUserInfo_(
    _ns1__CheckUserInfo*                ns1__CheckUserInfo,	///< Input parameter
    _ns1__CheckUserInfoResponse        &ns1__CheckUserInfoResponse	///< Output parameter
);
...
@section ns1 Top-level root elements of schema "http://tempuri.org/"
  ...
  - <ns1:NewCadFileDir> @ref _ns1__NewCadFileDir
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__NewCadFileDir(struct soap*, _ns1__NewCadFileDir*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__NewCadFileDir(struct soap*, _ns1__NewCadFileDir*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__NewCadFileDir(struct soap*, const char *URL, _ns1__NewCadFileDir*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__NewCadFileDir(struct soap*, const char *URL, _ns1__NewCadFileDir*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__NewCadFileDir(struct soap*, const char *URL, _ns1__NewCadFileDir*);
    soap_POST_recv__ns1__NewCadFileDir(struct soap*, _ns1__NewCadFileDir*);
    @endcode

  - <ns1:NewCadFileDirResponse> @ref _ns1__NewCadFileDirResponse
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__NewCadFileDirResponse(struct soap*, _ns1__NewCadFileDirResponse*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__NewCadFileDirResponse(struct soap*, _ns1__NewCadFileDirResponse*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__NewCadFileDirResponse(struct soap*, const char *URL, _ns1__NewCadFileDirResponse*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__NewCadFileDirResponse(struct soap*, const char *URL, _ns1__NewCadFileDirResponse*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__NewCadFileDirResponse(struct soap*, const char *URL, _ns1__NewCadFileDirResponse*);
    soap_POST_recv__ns1__NewCadFileDirResponse(struct soap*, _ns1__NewCadFileDirResponse*);
    @endcode

  - <ns1:DeleteCadFileDir> @ref _ns1__DeleteCadFileDir
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__DeleteCadFileDir(struct soap*, _ns1__DeleteCadFileDir*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__DeleteCadFileDir(struct soap*, _ns1__DeleteCadFileDir*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__DeleteCadFileDir(struct soap*, const char *URL, _ns1__DeleteCadFileDir*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__DeleteCadFileDir(struct soap*, const char *URL, _ns1__DeleteCadFileDir*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__DeleteCadFileDir(struct soap*, const char *URL, _ns1__DeleteCadFileDir*);
    soap_POST_recv__ns1__DeleteCadFileDir(struct soap*, _ns1__DeleteCadFileDir*);
    @endcode

  - <ns1:DeleteCadFileDirResponse> @ref _ns1__DeleteCadFileDirResponse
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__DeleteCadFileDirResponse(struct soap*, _ns1__DeleteCadFileDirResponse*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__DeleteCadFileDirResponse(struct soap*, _ns1__DeleteCadFileDirResponse*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__DeleteCadFileDirResponse(struct soap*, const char *URL, _ns1__DeleteCadFileDirResponse*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__DeleteCadFileDirResponse(struct soap*, const char *URL, _ns1__DeleteCadFileDirResponse*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__DeleteCadFileDirResponse(struct soap*, const char *URL, _ns1__DeleteCadFileDirResponse*);
    soap_POST_recv__ns1__DeleteCadFileDirResponse(struct soap*, _ns1__DeleteCadFileDirResponse*);
    @endcode

  - <ns1:DeleteCadFileDirByDirId> @ref _ns1__DeleteCadFileDirByDirId
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__DeleteCadFileDirByDirId(struct soap*, _ns1__DeleteCadFileDirByDirId*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__DeleteCadFileDirByDirId(struct soap*, _ns1__DeleteCadFileDirByDirId*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__DeleteCadFileDirByDirId(struct soap*, const char *URL, _ns1__DeleteCadFileDirByDirId*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__DeleteCadFileDirByDirId(struct soap*, const char *URL, _ns1__DeleteCadFileDirByDirId*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__DeleteCadFileDirByDirId(struct soap*, const char *URL, _ns1__DeleteCadFileDirByDirId*);
    soap_POST_recv__ns1__DeleteCadFileDirByDirId(struct soap*, _ns1__DeleteCadFileDirByDirId*);
    @endcode

  - <ns1:DeleteCadFileDirByDirIdResponse> @ref _ns1__DeleteCadFileDirByDirIdResponse
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__DeleteCadFileDirByDirIdResponse(struct soap*, _ns1__DeleteCadFileDirByDirIdResponse*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__DeleteCadFileDirByDirIdResponse(struct soap*, _ns1__DeleteCadFileDirByDirIdResponse*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__DeleteCadFileDirByDirIdResponse(struct soap*, const char *URL, _ns1__DeleteCadFileDirByDirIdResponse*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__DeleteCadFileDirByDirIdResponse(struct soap*, const char *URL, _ns1__DeleteCadFileDirByDirIdResponse*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__DeleteCadFileDirByDirIdResponse(struct soap*, const char *URL, _ns1__DeleteCadFileDirByDirIdResponse*);
    soap_POST_recv__ns1__DeleteCadFileDirByDirIdResponse(struct soap*, _ns1__DeleteCadFileDirByDirIdResponse*);
    @endcode

  - <ns1:RenameCadFileDir> @ref _ns1__RenameCadFileDir
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__RenameCadFileDir(struct soap*, _ns1__RenameCadFileDir*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__RenameCadFileDir(struct soap*, _ns1__RenameCadFileDir*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__RenameCadFileDir(struct soap*, const char *URL, _ns1__RenameCadFileDir*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__RenameCadFileDir(struct soap*, const char *URL, _ns1__RenameCadFileDir*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__RenameCadFileDir(struct soap*, const char *URL, _ns1__RenameCadFileDir*);
    soap_POST_recv__ns1__RenameCadFileDir(struct soap*, _ns1__RenameCadFileDir*);
    @endcode

  - <ns1:RenameCadFileDirResponse> @ref _ns1__RenameCadFileDirResponse
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__RenameCadFileDirResponse(struct soap*, _ns1__RenameCadFileDirResponse*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__RenameCadFileDirResponse(struct soap*, _ns1__RenameCadFileDirResponse*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__RenameCadFileDirResponse(struct soap*, const char *URL, _ns1__RenameCadFileDirResponse*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__RenameCadFileDirResponse(struct soap*, const char *URL, _ns1__RenameCadFileDirResponse*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__RenameCadFileDirResponse(struct soap*, const char *URL, _ns1__RenameCadFileDirResponse*);
    soap_POST_recv__ns1__RenameCadFileDirResponse(struct soap*, _ns1__RenameCadFileDirResponse*);
    @endcode

  - <ns1:GetProjectInfo> @ref _ns1__GetProjectInfo
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__GetProjectInfo(struct soap*, _ns1__GetProjectInfo*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__GetProjectInfo(struct soap*, _ns1__GetProjectInfo*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__GetProjectInfo(struct soap*, const char *URL, _ns1__GetProjectInfo*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__GetProjectInfo(struct soap*, const char *URL, _ns1__GetProjectInfo*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__GetProjectInfo(struct soap*, const char *URL, _ns1__GetProjectInfo*);
    soap_POST_recv__ns1__GetProjectInfo(struct soap*, _ns1__GetProjectInfo*);
    @endcode

  - <ns1:GetProjectInfoResponse> @ref _ns1__GetProjectInfoResponse
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__GetProjectInfoResponse(struct soap*, _ns1__GetProjectInfoResponse*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__GetProjectInfoResponse(struct soap*, _ns1__GetProjectInfoResponse*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__GetProjectInfoResponse(struct soap*, const char *URL, _ns1__GetProjectInfoResponse*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__GetProjectInfoResponse(struct soap*, const char *URL, _ns1__GetProjectInfoResponse*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__GetProjectInfoResponse(struct soap*, const char *URL, _ns1__GetProjectInfoResponse*);
    soap_POST_recv__ns1__GetProjectInfoResponse(struct soap*, _ns1__GetProjectInfoResponse*);
    @endcode

  - <ns1:UpdateCadDrawing> @ref _ns1__UpdateCadDrawing
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__UpdateCadDrawing(struct soap*, _ns1__UpdateCadDrawing*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__UpdateCadDrawing(struct soap*, _ns1__UpdateCadDrawing*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__UpdateCadDrawing(struct soap*, const char *URL, _ns1__UpdateCadDrawing*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__UpdateCadDrawing(struct soap*, const char *URL, _ns1__UpdateCadDrawing*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__UpdateCadDrawing(struct soap*, const char *URL, _ns1__UpdateCadDrawing*);
    soap_POST_recv__ns1__UpdateCadDrawing(struct soap*, _ns1__UpdateCadDrawing*);
    @endcode

  - <ns1:UpdateCadDrawingResponse> @ref _ns1__UpdateCadDrawingResponse
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__UpdateCadDrawingResponse(struct soap*, _ns1__UpdateCadDrawingResponse*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__UpdateCadDrawingResponse(struct soap*, _ns1__UpdateCadDrawingResponse*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__UpdateCadDrawingResponse(struct soap*, const char *URL, _ns1__UpdateCadDrawingResponse*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__UpdateCadDrawingResponse(struct soap*, const char *URL, _ns1__UpdateCadDrawingResponse*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__UpdateCadDrawingResponse(struct soap*, const char *URL, _ns1__UpdateCadDrawingResponse*);
    soap_POST_recv__ns1__UpdateCadDrawingResponse(struct soap*, _ns1__UpdateCadDrawingResponse*);
    @endcode

  - <ns1:DeleteCadDrawing> @ref _ns1__DeleteCadDrawing
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__DeleteCadDrawing(struct soap*, _ns1__DeleteCadDrawing*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__DeleteCadDrawing(struct soap*, _ns1__DeleteCadDrawing*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__DeleteCadDrawing(struct soap*, const char *URL, _ns1__DeleteCadDrawing*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__DeleteCadDrawing(struct soap*, const char *URL, _ns1__DeleteCadDrawing*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__DeleteCadDrawing(struct soap*, const char *URL, _ns1__DeleteCadDrawing*);
    soap_POST_recv__ns1__DeleteCadDrawing(struct soap*, _ns1__DeleteCadDrawing*);
    @endcode

  - <ns1:DeleteCadDrawingResponse> @ref _ns1__DeleteCadDrawingResponse
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__DeleteCadDrawingResponse(struct soap*, _ns1__DeleteCadDrawingResponse*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__DeleteCadDrawingResponse(struct soap*, _ns1__DeleteCadDrawingResponse*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__DeleteCadDrawingResponse(struct soap*, const char *URL, _ns1__DeleteCadDrawingResponse*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__DeleteCadDrawingResponse(struct soap*, const char *URL, _ns1__DeleteCadDrawingResponse*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__DeleteCadDrawingResponse(struct soap*, const char *URL, _ns1__DeleteCadDrawingResponse*);
    soap_POST_recv__ns1__DeleteCadDrawingResponse(struct soap*, _ns1__DeleteCadDrawingResponse*);
    @endcode

  - <ns1:DeleteCadDrawingByFileID> @ref _ns1__DeleteCadDrawingByFileID
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__DeleteCadDrawingByFileID(struct soap*, _ns1__DeleteCadDrawingByFileID*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__DeleteCadDrawingByFileID(struct soap*, _ns1__DeleteCadDrawingByFileID*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__DeleteCadDrawingByFileID(struct soap*, const char *URL, _ns1__DeleteCadDrawingByFileID*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__DeleteCadDrawingByFileID(struct soap*, const char *URL, _ns1__DeleteCadDrawingByFileID*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__DeleteCadDrawingByFileID(struct soap*, const char *URL, _ns1__DeleteCadDrawingByFileID*);
    soap_POST_recv__ns1__DeleteCadDrawingByFileID(struct soap*, _ns1__DeleteCadDrawingByFileID*);
    @endcode

  - <ns1:DeleteCadDrawingByFileIDResponse> @ref _ns1__DeleteCadDrawingByFileIDResponse
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__DeleteCadDrawingByFileIDResponse(struct soap*, _ns1__DeleteCadDrawingByFileIDResponse*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__DeleteCadDrawingByFileIDResponse(struct soap*, _ns1__DeleteCadDrawingByFileIDResponse*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__DeleteCadDrawingByFileIDResponse(struct soap*, const char *URL, _ns1__DeleteCadDrawingByFileIDResponse*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__DeleteCadDrawingByFileIDResponse(struct soap*, const char *URL, _ns1__DeleteCadDrawingByFileIDResponse*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__DeleteCadDrawingByFileIDResponse(struct soap*, const char *URL, _ns1__DeleteCadDrawingByFileIDResponse*);
    soap_POST_recv__ns1__DeleteCadDrawingByFileIDResponse(struct soap*, _ns1__DeleteCadDrawingByFileIDResponse*);
    @endcode

  - <ns1:CheckUserInfo> @ref _ns1__CheckUserInfo
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__CheckUserInfo(struct soap*, _ns1__CheckUserInfo*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__CheckUserInfo(struct soap*, _ns1__CheckUserInfo*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__CheckUserInfo(struct soap*, const char *URL, _ns1__CheckUserInfo*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__CheckUserInfo(struct soap*, const char *URL, _ns1__CheckUserInfo*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__CheckUserInfo(struct soap*, const char *URL, _ns1__CheckUserInfo*);
    soap_POST_recv__ns1__CheckUserInfo(struct soap*, _ns1__CheckUserInfo*);
    @endcode

  - <ns1:CheckUserInfoResponse> @ref _ns1__CheckUserInfoResponse
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__CheckUserInfoResponse(struct soap*, _ns1__CheckUserInfoResponse*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__CheckUserInfoResponse(struct soap*, _ns1__CheckUserInfoResponse*);
    // REST GET (returns SOAP_OK on success):
    soap_GET__ns1__CheckUserInfoResponse(struct soap*, const char *URL, _ns1__CheckUserInfoResponse*);
    // REST PUT (returns SOAP_OK on success):
    soap_PUT__ns1__CheckUserInfoResponse(struct soap*, const char *URL, _ns1__CheckUserInfoResponse*);
    // REST POST (returns SOAP_OK on success):
    soap_POST_send__ns1__CheckUserInfoResponse(struct soap*, const char *URL, _ns1__CheckUserInfoResponse*);
    soap_POST_recv__ns1__CheckUserInfoResponse(struct soap*, _ns1__CheckUserInfoResponse*);
    @endcode
