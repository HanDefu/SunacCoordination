...
private:
	...
	Acad::ErrorStatus InitDrawingControl(AcDbDatabase *p_pDb, const TCHAR *space = ACDB_MODEL_SPACE);
	Acad::ErrorStatus DrawBlockTableRecord(AcDbBlockTableRecord *pRec, AcDbDatabase *p_pDb);
