...
//////////////////////////////////////////////////////////////////////////////
//
// CSunacCoordinationDlg.cpp : implementation file
//
#include "StdAfx.h"
...
#include "SunacCoordination.h"
#include "SunacCoordinationDlg.h"
...
/////////////////////////////////////////////////////////////////////////////
// CSunacCoordinationDlg dialog


CSunacCoordinationDlg::CSunacCoordinationDlg(CWnd* pParent /*=NULL*/)
    : CAcUiDialog(CSunacCoordinationDlg::IDD, pParent)
{
    //{{AFX_DATA_INIT(CSunacCoordinationDlg)
    //}}AFX_DATA_INIT

}


void CSunacCoordinationDlg::DoDataExchange(CDataExchange* pDX)
{
    CAcUiDialog::DoDataExchange(pDX);
    //{{AFX_DATA_MAP(CSunacCoordinationDlg)
...
BEGIN_MESSAGE_MAP(CSunacCoordinationDlg, CAcUiDialog)
    //{{AFX_MSG_MAP(CSunacCoordinationDlg)
...
// Utility functions
void CSunacCoordinationDlg::DisplayPoint() 
{
...
bool CSunacCoordinationDlg::ValidatePoint() 
{
...
void CSunacCoordinationDlg::DisplayAngle() 
{
    m_ctrlAngleEdit.SetWindowText(m_strAngle);
    m_ctrlAngleEdit.Convert();
}

bool CSunacCoordinationDlg::ValidateAngle() 
{
...
void CSunacCoordinationDlg::DisplayBlocks() 
{
...
void CSunacCoordinationDlg::DisplayRegApps() 
{
...
/////////////////////////////////////////////////////////////////////////////
// CSunacCoordinationDlg message handlers

void CSunacCoordinationDlg::OnButtonPoint() 
{
...
void CSunacCoordinationDlg::OnButtonAngle() 
{
    // Hide the dialog and give control to the editor
    BeginEditorCommand();
...
void CSunacCoordinationDlg::OnKillfocusEditAngle() 
{
...
void CSunacCoordinationDlg::OnKillfocusEditXpt() 
{
    // Get and update text the user typed in.
    m_ctrlXPtEdit.Convert();
...
void CSunacCoordinationDlg::OnKillfocusEditYpt() 
{
    // Get and update text the user typed in.
    m_ctrlYPtEdit.Convert();
...
void CSunacCoordinationDlg::OnKillfocusEditZpt() 
{
    // Get and update text the user typed in.
    m_ctrlZPtEdit.Convert();
...
void CSunacCoordinationDlg::OnKillfocusComboRegapps() 
{
    CString strFromEdit;
...
void CSunacCoordinationDlg::OnOK() 
{
    if (!ValidatePoint()) {
...
BOOL CSunacCoordinationDlg::OnInitDialog() 
{
    // Set the dialog name for registry lookup and storage
    SetDialogName(_T("SunacCoordination:AsdkAcUiDialog"));
